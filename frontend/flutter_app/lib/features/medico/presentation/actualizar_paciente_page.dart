 ...
 Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            "Formulario para actualizar datos personales del paciente, informaci�n del tutor, alergias y su enfermedad principal.",
            style: GoogleFonts.inter(
                fontSize: 14,
  ...
  Widget _field(
    ...
    List<TextInputFormatter>? inputFormatters}) =>
      TextFormField(
          controller: c,
          validator: (v) {
            if (l.contains("*") && (v == null || v.trim().isEmpty)) return "Campo faltante, llene la informaci�n";
            return null;
          },
          maxLines: maxLines,
          enabled: enabled,
  ...
  Widget _dropdown(String l, List items, int? val, Function(int?) onC,
      ...
      DropdownButtonFormField<int>(
          value: val,
          validator: (v) {
            if (l.contains("*") && v == null) return "Campo faltante, llene la informaci�n";
            return null;
          },
          isExpanded: true,
          hint: hint != null
