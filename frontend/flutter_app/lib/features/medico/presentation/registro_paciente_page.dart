...
class _RegistroPacientePageState extends ConsumerState<RegistroPacientePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        Scaffold(
          backgroundColor: const Color(0xFFF8FAFC), // AppTema.grisLienzo
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (_tieneAlergiaSub) _multiSelectChips(
          ...
          _alergiasSub, 
          (id, s) { 
            if (_lactosa == true && _idsLacteos.contains(id)) return;
  ...
  // Helper methods to satisfy Task 4 requirements
  Widget _section(String title) => _sectionHeader(title, Icons.info_outline);
