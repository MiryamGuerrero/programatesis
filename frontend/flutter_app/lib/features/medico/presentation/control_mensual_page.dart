...
class _ControlMensualPageState extends ConsumerState<ControlMensualPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildTabBar() => Container(height: 60, color: Colors.white, child: TabBar(controller: _tabController, labelColor: AppTema.azulPrincipal, unselectedLabelColor: const Color(0xFF94A3B8), indicator: UnderlineTabIndicator(borderSide: BorderSide(width: 4, color: AppTema.azulPrincipal), insets: const EdgeInsets.symmetric(horizontal: 60)), labelStyle: GoogleFonts.montserrat(fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: 0.5), tabs: const [Tab(text: "REGISTRO CLÍNICO"), Tab(text: "MONITOR DE EVOLUCIÓN"), Tab(text: "BIOSEGURIDAD")]));
