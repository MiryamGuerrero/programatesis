      ...
      child: Column(
        children: [
          const ModuleHeaderCard(
            ...
            subtitle:
                "Consulta comidas programadas y usa cada item para registrar consumo diario.",
                ...
                : _items.isEmpty
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final idReceta = int.tryParse(
                              (item["id_receta"] ?? "").toString());
                          final recetaLabel = idReceta == null
                              ? "Receta sin ID"
                              : (_recetasById[idReceta] ?? "Receta $idReceta");
                          final idMomento = int.tryParse(
                              (item["id_momento"] ?? "").toString());
