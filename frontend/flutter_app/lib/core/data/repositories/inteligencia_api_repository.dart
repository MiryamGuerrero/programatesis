...
class InteligenciaApiRepository {
  ...
  Future<Map<String, dynamic>> calcularImc(
      {required double pesoKg, required double tallaCm}) {
  ...
  Future<Map<String, dynamic>> recetasPermitidas(
      {required String idPaciente, int? idMomento}) {
  ...
  Future<Map<String, dynamic>> ingredientesLista(
      {String q = "",
      int? cat,
      int? subcat,
      bool? active,
  ...
  Future<Map<String, dynamic>> guardarPlanManual(
      {required String idPaciente,
      required Map<String, dynamic> plan,
      bool replicate = true}) {
    return _post("plan-manual",
        {"id_paciente": idPaciente, "plan": plan, "replicate": replicate});
  }
}
