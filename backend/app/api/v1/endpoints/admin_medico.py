...
from app.services.admin_medico.adherence_service import calculate_adherence
from app.services.admin_medico.anthropometry_service import (
    calcular_imc,
    clasificar_imc_general,
    diagnostico_oms,
)
from app.services.compartido.rules_engine_service import evaluate_rules

router = APIRouter(tags=["Admin Medico"])
