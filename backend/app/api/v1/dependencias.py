...
from app.infraestructura.repositorios.repositorio_nutricion import RepositorioNutricionPostgres
...
def obtener_caso_uso_gestionar_catalogos() -> CasoUsoGestionarCatalogos:
    return CasoUsoGestionarCatalogos(repo_perfil=RepositorioPerfilPostgres())


def obtener_caso_uso_obtener_perfil() -> CasoUsoObtenerPerfilUsuario:
    return CasoUsoObtenerPerfilUsuario(repo_perfil=RepositorioPerfilPostgres())
...
def obtener_caso_uso_gestionar_ingredientes() -> CasoUsoGestionarIngredientes:
    return CasoUsoGestionarIngredientes(repo_ingrediente=RepositorioIngredientePostgres())


def obtener_caso_uso_gestionar_variables() -> CasoUsoGestionarVariables:
    return CasoUsoGestionarVariables(repo_nutricion=RepositorioNutricionPostgres())
...
def obtener_caso_uso_gestionar_seguimiento() -> CasoUsoGestionarSeguimiento:
    return CasoUsoGestionarSeguimiento(repo_seguimiento=RepositorioSeguimientoPostgres())
...
def obtener_caso_uso_gestionar_usuarios() -> CasoUsoGestionarUsuarios:
    return CasoUsoGestionarUsuarios(repo_perfil=RepositorioPerfilPostgres())
